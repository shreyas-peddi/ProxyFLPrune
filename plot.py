...
result_path = result_path = r"C:\Users\peddi\ProxyFL\resultsfashionmnistpruneepoch6"


algorithms = ['Regular', 'Joint', 'FedAvg', 'AvgPush', 'FML', 'ProxyFL','ProxyFLPrune']
...
for algorithm in algorithms:
    ...
    for seed in range(args.n_runs):
        ...
        try:
            ...
            print(f"Error loading {load_file}: {e}")
            continue

        algo_acc.append(load_results['proxy_accuracies'])
        if algorithm == 'FML' or algorithm == 'ProxyFL' or algorithm == 'ProxyFLPrune':
