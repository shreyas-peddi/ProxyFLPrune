...
parser.add_argument("--algorithm",
                    help="Algorithm: ['Regular', 'Joint', 'FedAvg', 'AvgPush', 'FML', 'ProxyFL', 'ProxyFLPrune'].",
                    type=str, choices=['Regular', 'Joint', 'FedAvg', 'AvgPush', 'FML', 'ProxyFL', 'ProxyFLPrune'],
                    default="ProxyFLPrune")
...
parser.add_argument("--result_path", help="Where to save results.",
                    type=str, default="./resultsdifmod")
